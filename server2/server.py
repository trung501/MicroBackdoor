...
import select, socket, urllib.request, urllib.parse, urllib.error
...
'''
    ...
    def flist(self, cancel = False, **data): 
        ...
        client_id, path = data['id'], urllib.parse.unquote_plus(data['p'])
        helper = ClientHelper(client_id)
...
'''
    ...
    def fput(self, cancel = False, **data): 
        ...
        client_id, path, f = data['id'], urllib.parse.unquote_plus(data['p']), data['file']
        helper = ClientHelper(client_id)
    ...
    def __init__(self):
        ...
        def _staticdir(section, dir, root = '', match = '', content_types = None, 
            ...
            if os.path.isdir(path_full):
                ...
                cherrypy.response.body = lister(path, path_full).encode("utf-8")
